...
public:
  ...
  virtual void urlEscape   (void); // more convenient but slower than urlEscape(StringA)
  virtual void urlUnescape (void); // more convenient but slower than urlUnescape(StringA)
  ...
  // concatenating
  virtual void join (const StringAVec& vecParts, const char* pszGlue);
  ...
  virtual void       pathExtractExtension       (bool bAll, StringA& strDest) const;
  virtual StringA    pathExtractExtension       (bool bAll) const;
  virtual void       pathExtractExtensionV      (bool bAll, StringAVec& vecDest) const;
  virtual StringAVec pathExtractExtensionV      (bool bAll) const;
  ...
  virtual bool       pathIsAbsoluteWin          (void) const;
  virtual bool       pathIsAbsoluteUnix         (void) const;
